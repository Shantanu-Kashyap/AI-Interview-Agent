            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                },
                {
                  ...
                  desc: "Detailed performance report with improvement tips.",
                },
                {
                  image: analyticsImg,
                  icon: <BsBarChart size={20} />,
                  title: "Performance Analytics",
                  desc: "Track progress with historical performance graphs and topic analysis.",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
            ...
            <div className="grid md:grid-cols-2 gap-10">
              {[
                ...
                },
                {
                  ...
                  desc: "Earn credits for interviews, redeem for rewards.",
                },
              ].map((mode, index) => (
                <motion.div
                  key={index}
